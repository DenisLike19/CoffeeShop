...
namespace Client.ViewModels
{
    public class KlientViewModel : ViewModelBase
    {
        ...
        public async Task Update()
        {
            ...
            Klients = JsonSerializer.Deserialize<ObservableCollection<Models.Klient>>(content);
            Message = "";
        }
        ...
        public async Task Add()
        {
            ...
            var content = await response.Content.ReadFromJsonAsync<Models.Klient>();
            if (content == null)
            {
